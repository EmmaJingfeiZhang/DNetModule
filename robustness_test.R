...
## this function take the edgelist and perturb a fixed percentage of of the edges
...
## this generates perturb the network, obtain the membership_perturb and calcucalte 
